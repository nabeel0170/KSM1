    ...
    <body>
        ...
        <div class=" navbar">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" href="../view/stock-manager-inventory-management.php">Inventory Management</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="../view/stock-manager-dashboard.php">Dashboard</a>
                </li>
            </ul>
        </div>
        <hr>
